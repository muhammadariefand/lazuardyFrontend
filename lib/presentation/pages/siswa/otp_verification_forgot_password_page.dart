...
class OtpVerificationForgotPasswordPage extends StatefulWidget {
  final String? email;
  ...
  @override
  State<OtpVerificationForgotPasswordPage> createState() => _OtpVerificationForgotPasswordPageState();
}

class _OtpVerificationForgotPasswordPageState extends State<OtpVerificationForgotPasswordPage> {
  ...
  void _onVerify(String email) {
    if (!_isOtpComplete) {
      ...
      return;
        ...
        // Panggil Cubit (gunakan method yang ada di AuthCubit)
        context.read<AuthCubit>().studentVerifyOtp(email, _otpValue);
  }
        ...
        child: BlocConsumer<AuthCubit, AuthState>(
          listener: (context, state) {
            if (state is AuthSuccess) {
              // Registrasi berhasil: navigasi ke detail pribadi
            ...
            if (state is OtpVerifiedSuccess) {
              // OTP forgot-password terverifikasi: navigasi ke halaman reset password
              Navigator.of(context).pushNamed('/siswa/reset-password', arguments: {
                'email': emailArg,
