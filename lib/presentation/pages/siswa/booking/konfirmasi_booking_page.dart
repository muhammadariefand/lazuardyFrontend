...
class _KonfirmasiBookingPageState extends State<KonfirmasiBookingPage> {
  void _onKonfirmasi(Map args) {
    String finalAddress = 'Online';
    if (args['alamat'] != null && args['alamat'].toString().trim().isNotEmpty) {
      finalAddress = args['alamat'].toString().trim();
    } else if (args['maps'] != null &&
        args['maps'].toString().trim().isNotEmpty) {
      finalAddress = args['maps'].toString().trim();
    }
  ...
  Widget build(BuildContext context) {
    ...
    final mapel =
        args['tutor_mapel'] as String? ??
        args['mapel'] as String? ??
        'Matematika';
