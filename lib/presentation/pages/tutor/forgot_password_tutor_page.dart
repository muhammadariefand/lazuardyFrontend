// lib/presentation/pages/tutor/forgot_password_tutor_page.dart
...
class ForgotPasswordTutorPage extends StatefulWidget {
  const ForgotPasswordTutorPage({super.key});

  @override
  State<ForgotPasswordTutorPage> createState() => _ForgotPasswordTutorPageState();
}

class _ForgotPasswordTutorPageState extends State<ForgotPasswordTutorPage> {
