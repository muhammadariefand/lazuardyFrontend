// lib/presentation/widgets/orangtua_drawer.dart
              ...
              child: Column(children: [
                _MenuItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.pushNamed(context, '/orang-tua/hubungi-kami');
                  },
                ),
                const SizedBox(height: 12),
                _MenuItem(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.pushNamed(context, '/orang-tua/tentang-kami');
                  },
                ),
                const SizedBox(height: 12),
                _MenuItem(
