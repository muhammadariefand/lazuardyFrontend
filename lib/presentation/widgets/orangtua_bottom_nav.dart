// lib/presentation/widgets/orangtua_bottom_nav.dart
// Bottom navigation bar reusable untuk semua halaman Orang Tua

import 'package:flutter/material.dart';
import 'package:lazuadry_mobile_fe/core/theme/app_theme.dart';


class OrangTuaBottomNav extends StatelessWidget {
  final int currentIndex;
  final ValueChanged<int> onTap;
  const OrangTuaBottomNav({super.key, required this.currentIndex, required this.onTap});

  static const _items = [
    (Icons.home_rounded, 'Beranda'),
    (Icons.calendar_today_rounded, 'Jadwal'),
    (Icons.menu_book_rounded, 'Laporan'),
